...
public class AddInvestmentFragment extends Fragment implements LineDialogFragment.OnListClickLitsener{

    private FragmentAddInvestmentBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAddInvestmentBinding.inflate(inflater,container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.LineLy.setEndIconOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lineDialogFragment.setTargetFragment(AddInvestmentFragment.this,2);
